...
const navSections = [
    ...
    },
    {
        label: 'Plan',
        items: [
            { label: 'Strategy', icon: Compass, to: '/strategy' },
...
export default function Sidebar() {
    return (
        <aside className="fixed left-0 top-0 h-screen w-52 bg-white border-r border-gray-200 dark:bg-dark-800 dark:border-dark-700 flex flex-col z-40 shadow-sm">
            {/* Logo / Brand */}
