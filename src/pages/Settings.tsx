...
export default function Settings() {
  ...
  return (
    <div className="flex min-h-screen bg-gray-50 dark:bg-dark-900 text-gray-900 dark:text-white">
      <Sidebar />
        ...
        <main className="flex-1 p-8 space-y-8 overflow-y-auto">
          ...
          <section className="card">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input className="input-field" value={contactEmail} onChange={(e) => setContactEmail(e.target.value)} />
              </div>
              <div className="md:col-span-2">
                <label className="block text-sm font-semibold mb-1">Bio / Brand Description</label>
                <textarea className="input-field h-24 resize-none" value={bio} onChange={(e) => setBio(e.target.value)} />
              </div>
            </div>
            <div className="mt-4">
            ...
            <div className="space-y-3">
              {[
                ...
                <div key={acc.name} className="flex items-center justify-between">
                  ...
                  <button className="text-xs text-brand-green">{acc.connected ? 'Connected' : 'Connect'}</button>
                </div>
              ))}
            </div>
          </section>
          ...
          <section className="card">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
              <div>
                <ToggleSwitch checked={bharatMode} onChange={setBharatMode} label="Bharat Mode" />
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">AI outputs tailored for the Indian audience</p>
              </div>
              <div>
          ...
          <section className="card">
            ...
            <div className="space-y-4">
              <ToggleSwitch checked={weeklyReports} onChange={setWeeklyReports} label="Weekly Performance Reports" />
              <ToggleSwitch checked={ideaAlerts} onChange={setIdeaAlerts} label="AI Idea Generation Alerts" />
              <ToggleSwitch checked={socialEngagement} onChange={setSocialEngagement} label="Social Media Engagement" />
            </div>
          </section>
          ...
          <section className="card">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">Manage your plan, invoices, and payment methods. (Page under construction)</p>
          </section>
        </main>
      </div>
    </div>
